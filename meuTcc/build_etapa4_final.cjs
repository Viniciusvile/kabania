/**
 * Etapa 4 - Introducao e Resultados Esperados (consistente com o TCC completo)
 * Introducao = Capitulo 1 VERBATIM do completo. Resultados Esperados = numeros do completo.
 * Saida: TCC_Etapa4_Introducao_Resultados_Esperados.docx (meuTcc + Downloads)
 */
const fs = require("fs");
...
function p(text, opts = {}) {
  ...
  return new Paragraph({ alignment: align,
...
function h1(text) { return new Paragraph({ heading: HeadingLevel.HEADING_1, alignment: AlignmentType.LEFT,
  spacing: { before: 480, after: 360, line: 360 }, pageBreakBefore: true,
  children: [new TextRun({ text, bold: true, size: 28, font: FONT })] }); }
function h2(text) { return new Paragraph({ heading: HeadingLevel.HEADING_2, alignment: AlignmentType.LEFT,
  spacing: { before: 360, after: 240, line: 360 },
  children: [new TextRun({ text, bold: true, size: 26, font: FONT })] }); }
function h3(text) { return new Paragraph({ heading: HeadingLevel.HEADING_3, alignment: AlignmentType.LEFT,
  spacing: { before: 280, after: 180, line: 360 },
  children: [new TextRun({ text, bold: true, italics: true, size: 24, font: FONT })] }); }
function numItem(text) { return new Paragraph({ numbering: { reference: "numbers", level: 0 },
...
function bullet(text) { return new Paragraph({ numbering: { reference: "bullets", level: 0 },
  spacing: { line: 360, after: 60 }, alignment: AlignmentType.JUSTIFIED,
  children: [new TextRun({ text, size: 24, font: FONT })] }); }
function ref(text) { return new Paragraph({ spacing: { line: 280, after: 200 }, alignment: AlignmentType.JUSTIFIED,
  children: [new TextRun({ text, size: 24, font: FONT })] }); }
...
function celula(text, opts = {}) {
  ...
  return new TableCell({ borders: bordas, width: { size: width, type: WidthType.DXA },
...
function legendaTabela(text) { return new Paragraph({ alignment: AlignmentType.CENTER, spacing: { before: 200, after: 120 },
  children: [new TextRun({ text, bold: true, size: 22, font: FONT })] }); }
function fonteTabela(text) { return new Paragraph({ alignment: AlignmentType.CENTER, spacing: { before: 80, after: 240 },
...
conteudo.push(
  ...
  new Paragraph({ alignment: AlignmentType.RIGHT, indent: { left: 4500 }, spacing: { line: 280 },
    children: [new TextRun({ text: "Etapa 4 – Introdução e Resultados Esperados do Trabalho de Conclusão de Curso, apresentada à Universidade Paulista – UNIP como requisito parcial para obtenção do título de Bacharel em Ciência da Computação. Documento submetido à apreciação do(a) orientador(a).", size: 22, font: FONT })] }),
  blank(1)[0],
  new Paragraph({ alignment: AlignmentType.RIGHT, indent: { left: 4500 }, spacing: { line: 280 },
...
conteudo.push(
  ...
  p("2 RESULTADOS ESPERADOS .............................................................................. 7"),
  p("2.1 Hipóteses de Pesquisa ......................................................................................... 7"),
  p("2.2 Resultados Esperados quanto aos Tempos Operacionais ................................. 7"),
  p("2.3 Resultados Esperados quanto a SLA e First Contact Resolution ..................... 8"),
  p("2.4 Resultados Esperados quanto à Eficiência Computacional ............................. 9"),
  p("2.5 Resultados Esperados quanto ao Retorno Financeiro ....................................... 9"),
  p("2.6 Validação Preliminar e Síntese das Expectativas .......................................... 10"),
  p("REFERÊNCIAS .................................................................................................... 11"),
  new Paragraph({ children: [new PageBreak()] })
);

// ============================================================
// 1 INTRODUCAO  (VERBATIM do TCC completo)
// ============================================================
...
conteudo.push(
  numItem("Caracterizar, com base na literatura especializada, os componentes de tempo (Wait Time, Touch Time, Cycle Time e Lead Time) que compõem o ciclo de execução de uma tarefa em um sistema Kanban Tradicional."),
  numItem("Projetar a arquitetura lógica do Mecanismo Kanban IA, descrevendo a sinergia entre o backend Supabase/PostgreSQL, o frontend React/Vite, a camada de RLS e a integração com a API do Google Gemini, formalizada por meio de diagramas UML (Casos de Uso, Sequência e DER)."),
  numItem("Implementar um simulador de eventos discretos em Node.js capaz de gerar amostras estatísticas comparáveis entre o Kanban Tradicional e o Mecanismo Kanban IA, executando ao menos 30 réplicas independentes para fins de inferência estatística."),
  numItem("Mensurar, sobre amostras de 100 cartões operacionais por réplica, os ganhos relativos nas dimensões de tempo, conformidade de SLA, FCR e consumo de tokens, submetendo as diferenças a teste t pareado bilateral."),
  numItem("Traduzir os ganhos técnicos em projeções financeiras (ROI), fornecendo argumentos quantitativos para a defesa acadêmica e para a adoção corporativa.")
);
...
// ============================================================
// 2 RESULTADOS ESPERADOS  (numeros do TCC completo)
// ============================================================
conteudo.push(h1("2 RESULTADOS ESPERADOS"));
conteudo.push(
  p("Este capítulo formaliza as hipóteses de pesquisa e os resultados esperados do experimento de validação, articulando-os com as projeções preliminares já obtidas a partir das primeiras execuções do modelo de simulação descrito na metodologia. Os valores numéricos aqui apresentados constituem expectativas fundamentadas — derivadas tanto da literatura quanto de execuções preliminares do simulador —, cuja consolidação definitiva será apresentada no capítulo de resultados da versão final do trabalho.", { indent: true })
);

conteudo.push(h2("2.1 Hipóteses de Pesquisa"));
conteudo.push(
  p("A pesquisa estrutura-se em torno de uma hipótese central e quatro hipóteses derivadas, todas passíveis de verificação por meio do experimento de simulação:", { indent: true, spacingAfter: 120 }),
  ...
  p("A hipótese nula (H0) correspondente sustenta que não há diferença estatisticamente significativa entre os dois sistemas. O experimento visa, portanto, rejeitar H0 ao nível de significância α = 0,001.", { indent: true, spacingBefore: 120 })
);

conteudo.push(h2("2.2 Resultados Esperados quanto aos Tempos Operacionais"));
conteudo.push(p("Espera-se que o Mecanismo Kanban IA promova reduções expressivas nas três métricas temporais analisadas, com destaque para o Wait Time, em conformidade com a hipótese H1a. A Tabela 1 sintetiza os resultados esperados, já corroborados pelas projeções preliminares da simulação.", { indent: true }));
...
conteudo.push(new Table({
  width: { size: 9360, type: WidthType.DXA }, columnWidths: [2760, 2200, 2200, 2200],
  rows: [
...
conteudo.push(
  p(`A partir dos ganhos de tempo projetados, espera-se demonstrar retorno financeiro relevante. Considerando um custo médio de R$ 50,00 por hora técnica operacional, estima-se a economia de aproximadamente ${horasSalvas} horas operacionais a cada lote de 100 cartões processados. Projetada para uma operação de médio porte, com mil chamados mensais, essa economia deverá ultrapassar a marca de um milhão de reais anuais em força de trabalho, sem contabilizar ganhos indiretos com a redução de passivos contratuais por descumprimento de SLA e com a melhoria da experiência do cliente.`, { indent: true, spacingAfter: 200 }),
  p("Ressalta-se que tais valores constituem estimativa de cenário, e não um retorno auditado, destinando-se a dimensionar a ordem de grandeza do impacto econômico potencial da solução.", { indent: true })
);

conteudo.push(h2("2.6 Validação Preliminar e Síntese das Expectativas"));
conteudo.push(p("As projeções preliminares obtidas a partir das primeiras execuções do simulador, com replicação Monte Carlo de trinta amostras, corroboram integralmente as hipóteses formuladas. O teste t pareado bilateral aplicado às diferenças entre os dois sistemas produziu estatísticas t consistentemente superiores ao valor crítico de 3,659 (referente a vinte e nove graus de liberdade e α = 0,001) em todas as métricas analisadas, conforme sintetizado na Tabela 2.", { indent: true }));
conteudo.push(legendaTabela("Tabela 2 – Síntese das expectativas e significância estatística preliminar"));
conteudo.push(new Table({
  width: { size: 9360, type: WidthType.DXA }, columnWidths: [3360, 3000, 3000],
  rows: [
    new TableRow({ tableHeader: true, children: [
...
const doc = new Document({
  creator: "Vinicius Vilela Rufini", title: "TCC - Etapa 4 - Introducao e Resultados Esperados",
  description: "Etapa 4 do TCC - consistente com o TCC completo - UNIP",
  styles: { default: { document: { run: { font: FONT, size: 24 } } },
    paragraphStyles: [
      { id: "Heading1", name: "Heading 1", basedOn: "Normal", next: "Normal", quickFormat: true,
        run: { font: FONT, size: 28, bold: true }, paragraph: { spacing: { before: 480, after: 360, line: 360 }, outlineLevel: 0 } },
      { id: "Heading2", name: "Heading 2", basedOn: "Normal", next: "Normal", quickFormat: true,
        run: { font: FONT, size: 26, bold: true }, paragraph: { spacing: { before: 360, after: 240, line: 360 }, outlineLevel: 1 } },
      { id: "Heading3", name: "Heading 3", basedOn: "Normal", next: "Normal", quickFormat: true,
        run: { font: FONT, size: 24, bold: true, italics: true }, paragraph: { spacing: { before: 280, after: 180, line: 360 }, outlineLevel: 2 } },
    ] },
  numbering: { config: [
  ...
  sections: [{
    ...
    footers: { default: new Footer({ children: [new Paragraph({ alignment: AlignmentType.CENTER,
      children: [new TextRun({ text: "Página ", size: 18, font: FONT }), new TextRun({ children: [PageNumber.CURRENT], size: 18, font: FONT })] })] }) },
    children: conteudo
  }]
});
...
(async () => {
  ...
  const o1 = path.join(BASE, "TCC_Etapa4_Introducao_Resultados_Esperados.docx");
  const o2 = "C:\\Users\\vinic\\Downloads\\TCC_Etapa4_Introducao_Resultados_Esperados.docx";
  fs.writeFileSync(o1, buffer);
  fs.writeFileSync(o2, buffer);
  console.log(`OK -> ${o1} (${(fs.statSync(o1).size/1024).toFixed(1)} KB)`);
  console.log(`OK -> ${o2}`);
})();
